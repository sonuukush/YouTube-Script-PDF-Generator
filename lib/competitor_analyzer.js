 ...
 */
function rankVideosByRetentionScore(videos) {
...
/**
 * Extracts and tallies top recurring keywords/topics across all transcripts.
 * @param {Array} fullData - Array of objects containing scripts
 * @returns {Array} Top 15 recurring keywords with frequencies
 */
function extractTrendingKeywords(fullData) {
    ...
    for (const item of fullData) {
        ...
        // Clean and tokenize
        const tokens = item.script.toLowerCase()
