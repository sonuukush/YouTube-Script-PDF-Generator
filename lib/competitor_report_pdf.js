 ...
 * @param {Object} reportData - All report metrics, top videos, hooks, and generated scripts
...
<body>
    ...
    <div class="cover-page">
        ...
        <div class="cover-meta">
            ...
            <strong>AI Text Generation Engine:</strong> Pollinations.ai (Free Cloud API)<br>
        ...
        <tbody>
            ${topVideos.map((v, idx) => `
                <tr>
                    ...
                    <td>${(v.likes !== undefined && v.likes !== null && v.likes > 0) ? v.likes.toLocaleString() : ((v.likes === 0) ? '0' : '<span style="color:#64748b; font-size:11px;">N/A (Hidden)</span>')}</td>
    ...
    // Render PDF via Headless Chromium / Edge / Chrome
    const browserExe = getBrowserExecutable();
    const cmd = `${browserExe} --headless --no-sandbox --disable-gpu --disable-dev-shm-usage --print-to-pdf="${outputPdfPath}" "file:///${htmlPath.replace(/\\/g, '/')}"`;
    execSync(cmd);
